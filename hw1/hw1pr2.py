...
if __name__ == '__main__':
    ...
    X_space_stacked = np.zeros((100, 2))
    X_space_stacked[:, 0] = np.ones(100)
    X_space_stacked[:, 1] = X_space
    print(X_space_stacked)
    W_opt = None
    "*** YOUR CODE HERE ***"
    W_opt = np.linalg.inv(X_space_stacked.T @ X_space_stacked) @ X_space_stacked.T @ y_space_rand
    "*** END YOUR CODE HERE ***"
